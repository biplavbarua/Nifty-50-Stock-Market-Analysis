...
### Unit III: Classification Analysis
*   **Models:** Logistic Regression, Support Vector Machines (SVM).
*   **Features:** RSI (Relative Strength Index), MACD, and Daily Returns.
*   **Results:** The SVM model successfully classified "Up" vs. "Down" days with reasonable accuracy, proving that technical indicators contain predictive signal.
